...
default ra = ChatCharacter(
                ...
                cover_pic="Hololive Cover Photos/ra_cover_image.jpg",
...
default sh = ChatCharacter(
                ...
                image="emma",
                oice_tag="em_voice")
default bi = ChatCharacter(
                name="Biboo",
                file_id="bi",
                prof_pic="Hololive Profiles/bijou_default.png",
                heart_color="#8C85A6",
                participant_pic="Hololive Profiles/bijou profiles/beeb_smirk.png",
                cover_pic="Cover Photos/emma_cover.png",
                status="sticking out your gyatt for nerizzler!",
                bubble_color="#635EF2",
                glow_color="#4843D9",
                homepage_pic="Profile Pics/main_profile_emma.webp",
                vn_name="Bijou",
                ...
                image="emma",
                oice_tag="em_voice")
default fw = ChatCharacter(
                name="Fuwawa",
                file_id="fw",
                prof_pic="Hololive Profiles/fuwawa_default.png",
                heart_color="#BBD6FF",
                participant_pic="Hololive Profiles/fuwawa profiles/happy_fuwawa.png",
                cover_pic="Cover Photos/emma_cover.png",
                status="I'm not a chihuahua, I'm Fuwawa!",
                bubble_color="#67B2FF",
                glow_color="#419FD9",
                homepage_pic="Profile Pics/main_profile_emma.webp",
                vn_name="Fuwawa",
                ...
                image="emma",
                oice_tag="em_voice")
default mc = ChatCharacter(
                name="Mococo",
                file_id="mc",
                prof_pic="Hololive Profiles/mococo_default.png",
                heart_color="#FF82C9",
                participant_pic="Hololive Profiles/mococo profiles/happy_mococo.png",
                cover_pic="Cover Photos/emma_cover.png",
                status="I'm not Fuwawa, I'm Mococo!",
                bubble_color="#F7A6CA",
                glow_color="#FCA3B3",
                homepage_pic="Profile Pics/main_profile_emma.webp",
                vn_name="Fuwawa",
